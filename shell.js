...
const Shell = (() => {
  const ROUTES = [
    ...
    { group: 'Pessoas', id: 'colaboradores', label: 'Colaboradores', href: 'gestao_rh_sst.html', icon: 'users', perfis: ['all'] },
    { group: 'Pessoas', id: 'admissoes', label: 'Admissoes', href: 'recrutamento_selecao.html', icon: 'user-plus', perfis: ['administrador','rh'] },
    { group: 'Pessoas', id: 'desligamentos', label: 'Desligamentos', href: 'gestao_rh_sst.html', icon: 'user-minus', perfis: ['administrador','rh'] },
    { group: 'Processos', id: 'ocorrencias', label: 'Ocorrencias', href: 'gestao_rh_sst.html', icon: 'file-text', perfis: ['administrador','rh'] },
    { group: 'Processos', id: 'experiencia', label: 'Contratos Exp.', href: 'gestao_rh_sst.html', icon: 'calendar', perfis: ['administrador','rh'] },
    ...
    { group: 'Operacional', id: 'esocial', label: 'eSocial', href: 'monitor-esocial.html', icon: 'clipboard', perfis: ['administrador','rh'] },
    { group: 'Gestao', id: 'lideranca', label: 'Lideranca', href: 'lideranca.html', icon: 'award', perfis: ['administrador','rh'] },
    { group: 'Gestao', id: 'saude_ocupacional', label: 'Saude Ocupacional', href: 'saude_mental.html', icon: 'heart', perfis: ['administrador','rh'] },
    { group: 'Gestao', id: 'recrutamento', label: 'Recrutamento', href: 'recrutamento_selecao.html', icon: 'user-plus', perfis: ['administrador','rh'] },
    { group: 'Ferramentas', id: 'agente_ia', label: 'Agente IA', href: 'agente-ia.html', icon: 'code', perfis: ['administrador','rh'] },
    { group: 'Ferramentas', id: 'ficha_360', label: 'Ficha 360', href: 'ficha_360.html', icon: 'search', perfis: ['administrador','rh','gestor'] },
    { group: 'Ferramentas', id: 'exportar', label: 'Exportar Pagtos', href: 'exportar_pagamentos.html', icon: 'download', perfis: ['administrador','rh'] },
  ];
